 ...
 titlePanel("Brugada Syndrome Risk Stratification"),
  ...
  sidebarLayout(
    ...
    mainPanel( 
      ...
      p("Reference: S Honarbakhsh, R Providencia, J Garcia-Hernandez, et al … , PD Lambiase. A Primary Prevention Clinical Risk Score Model for Patients With Brugada Syndrome (BRUGADA-RISK). JACC Clin Electrophysiol 2020 Oct 28;", a("[EPub Ahead of Print]", href="https://www.jacc.org/doi/10.1016/j.jacep.2020.08.032")),
...
server <- function(input, output, session){
  ...
  output$plot_circle <- renderPlot(expr = {
    ...
    #risk_at_5 <- "tmp"
    risk_at_5 <- subset(RF_tab, Risk_Score == user_risk & country == "AVE")
